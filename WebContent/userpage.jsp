...
<div class="main">
  ...
  <div class="header">
    <div class="logo">
      <h1><a href="index.html"><span>Assured and Aggressive Multi-keyword Ranked Search 
	  Scheme in Shared Environment over Encrypted Data</span></a></h1>
    </div>
  ...
  <div class="content">
    <div class="mainbar">
      <div class="article">
        <h2><span>Data Search Service..!</span></h2>
        <div class="clr"></div>
       <%
       ...
       out.println("<script>alert('Downloaded sucess..!')</script>");
       }
       %>
       <img src="images/cloudsearch.jpg" width="613" height="193" alt="" />
       <form action="search.jsp" name="ff"  method="get" onsubmit="return check()">
                 
           Welcome: <font color="red"><%=my%></font><br></br>
           
           Enter the Keyword: <br><input type="text" name="search" id="user" style="background: #00ccff; height: 28px;  width:250px;"><br><br>                   
                    <div style="margin-left: 3px;">  
                        <input type="submit" value="Search" style="background-color: green; width: 80px; height: 30px; border: 4px; font-weight: bold;">&nbsp;&nbsp;&nbsp;
                    </form>
